...
import {
  ArrowLeft, Building2, Calendar, Check, Clock, FileText, Globe, Info,
...
>
  ...
  >
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
      ...
      <div style={{ fontSize: '12px', color: '#6b7e91', fontWeight: 500 }}>
        Click to upload images
      </div>

      <div style={{ fontSize: '11px', color: '#aab4bf' }}>
        PNG, JPG up to 25MB
      </div>
    </div>
  </div>

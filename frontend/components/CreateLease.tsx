...
export default function CreateLease() {
  ...
  (window as any).selectedSpaceId = unit.spaceId;
                ...
                <div>
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        updateField("leaseForUnitId", e.target.value)
                      }
              ...
              <div style={{ display: "grid", gap: "9px" }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      updateField("leaseInvoicePeriod", e.target.value)
                    }
                  >
                    <option>Select an option</option>
